...
export async function generateStaticParams() {
  return getAllStatePages().map(({ state }) => ({ state }));
}
...
export async function generateMetadata({
  ...
  if (!stateName) return {};
  return {
    title: `Bulk CTC Tea Supplier in ${stateName} | BulkCTC`,
    description: `Wholesale bulk CTC tea supply for businesses across ${stateName}. Hotels, factories, corporate offices, and institutions. Direct from Assam gardens.`,
