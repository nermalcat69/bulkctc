...
export async function generateMetadata({
  ...
  if (!cityInfo) return {};
  return {
    title: `Bulk CTC Tea Supplier in ${cityInfo.city}, ${cityInfo.state} | BulkCTC`,
    description: `Wholesale bulk CTC tea for businesses in ${cityInfo.city}, ${cityInfo.state}. ${cityInfo.transitDays} delivery. Hotels, factories, corporate offices. Min. order ${cityInfo.supplyChain.moq}.`,
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {cityInfo.industries.map((industry) => (
                <span
                  key={industry}
                  className="bg-neutral-100 px-3 py-1.5 text-sm text-neutral-700"
                >
                  {industry}
                </span>
              ))}
