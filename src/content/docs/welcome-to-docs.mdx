...
hero:
  ...
  actions:
    ...
    - text: View on GitHub
      icon: external
      variant: minimal
      link: https://github.com/mearashadowfax/BulkCTC
---
...
<CardGrid stagger>
  ...
  <Card title="Tools & Equipment" icon="seti:eslint">
    Discover the complete lineup of BulkCTC's superior quality tools and equipment. Each subsection offers detailed specifications, usage instructions, and maintenance tips.
  </Card>
